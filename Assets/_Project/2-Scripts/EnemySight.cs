...
public class EnemySight : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
       ...
       susInsideBox = Physics.BoxCast(transform.position, pointBlankCube, transform.forward, out hit, transform.rotation, farRange, playerLayer);
       if (susInsideBox)
       {
    ...
    void OnDrawGizmos()
    {
        ...
        //point blank range
        DrawBoxCastBox(transform.position, pointBlankCube, transform.rotation, transform.forward, pointBlankRange, Color.red);

        //mid range
         DrawBoxCastBox(transform.position + transform.forward*pointBlankRange, pointBlankCube, transform.rotation, transform.forward, midRange-pointBlankRange, Color.yellow);

         //far range
         DrawBoxCastBox(transform.position + transform.forward*midRange, pointBlankCube, transform.rotation, transform.forward, farRange-midRange, Color.green);
    }
